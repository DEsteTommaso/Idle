...
public class upgradeTorrettaLivello4 : MonoBehaviour
{
    public Text livello;
    public Text prezzo;
    ...
    private void HandleButtonClick()
    {
        ...
        if (liv <= 5)
        {
            if (i >= singleton.QuartoLivelloSpawnEDannoSoldi[liv])
            {
                ...
                singleton.LivelloQuartoLivelloDannoMitraglietta = liv;
    ...
    {
        liv = singleton.LivelloQuartoLivelloDannoMitraglietta + 1;
        if (liv >= 6)
            prezzo.text = "MAX";
        else
        ...
        if (singleton.Lingua.Equals("it"))
            frequenza.text = "Danno " + singleton.QuartoLivelloTorretta[liv - 1].ToString() + " ogni 3s";
        else if (singleton.Lingua.Equals("en"))
            frequenza.text = "Damage " + singleton.QuartoLivelloTorretta[liv - 1].ToString() + " every 3s";
