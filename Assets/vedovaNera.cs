...
public class vedovaNera : MonoBehaviour
{
    ...
    IEnumerator sparare()
    {
        ...
        while (joystick.IsTouching && !singleton.MorteGiocatoreDungeon)
        {
            ...
            else if(singleton.Munizione - 5 >= 0)
            {
                singleton.removeMunizione(5);
            ...
            //assegnareColpiArmi.sparare(personaggio);

            //newpallottola.GetComponent<pallottola_vedovaNera>().setTarget(position);
