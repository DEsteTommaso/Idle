...
public class pulsanteArma4 : MonoBehaviour
{
    ...
    private void HandleButton()
    {
        if (!singleton.CompratoArma4)
        {
            if (singleton.Moneta >= 70000)
            {
                resetSelezionamento();
                singleton.removeMoneta(70000);
                singleton.CompratoArma4 = true;
                singleton.SelezionatoArma4 = true;
