...
public class upgradeCapienzaLiquidoLivello2 : MonoBehaviour
{
    public Text livello;
    public Text prezzo;
    ...
    private void HandleButtonClick()
    {
        ...
        if (liv <= 10)
        {
            if (i >= singleton.SecondoLivelloProduzioneEContenitoreSoldi[liv])
            {
                ...
                singleton.LivelloSecondoLivelloCapienzaContenitoreElisir = liv;
    ...
    private void refresh()
    {
        ...
        liv = singleton.LivelloSecondoLivelloCapienzaContenitoreElisir + 1;
        ...
        if (singleton.Lingua.Equals("it"))
            frequenza.text = singleton.SecondoLivelloContenitore[liv - 1].ToString() + " Elisir";
        else if (singleton.Lingua.Equals("en"))
            frequenza.text = singleton.SecondoLivelloContenitore[liv - 1].ToString() + " Elixir";
    }
}
