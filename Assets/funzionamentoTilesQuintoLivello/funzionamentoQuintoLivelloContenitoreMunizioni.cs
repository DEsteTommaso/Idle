...
public class funzionamentoQuintoLivelloContenitoreMunizioni : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        lev = singleton.LivelloQuintoLivelloCapienzaContenitoreMunizioni;

        singleton.QuintoLivelloContenitoreMunizioni = a[lev];
