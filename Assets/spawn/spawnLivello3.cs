...
public class spawnLivello3 : MonoBehaviour
{
    ...
    void Update()
    {
        tempo = singleton.TerzoLivelloSpawn[singleton.LivelloTerzoLivelloVelocitaSpawn];
        ...
        testoMaxMostri.text = singleton.MostriLivello3.ToString() + "/6";
    }
